...
try {
  const bloomDisplay = document.getElementById("bloomDisplay");
  const user = JSON.parse(localStorage.getItem("bloxiumUser"));
  if (user && bloomDisplay) bloomDisplay.innerText = user.blooms;
} catch (e) {}
